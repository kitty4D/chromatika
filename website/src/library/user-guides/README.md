...
- [multi-vault siblings](/library/user/multi-vault-siblings) - bip44-style multiple vaults from one passkey / hardware / waap / lazor / phrase identity
- [find more accounts](/library/user/find-more-accounts) - post-unlock activity scan + dwallet inventory + orphan detection + inline sibling-add
